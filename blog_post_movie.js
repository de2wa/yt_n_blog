...
for(var k = 0; k < dataEmail.length; k++)
  ...
  for(var j = num; j < num + 10; j++)
    ...
    var konten2 = ["<h3>" + datajudul[j] + " Full Movie</h3> <img alt='" + datajudul[j] + "' src='" + dataimage[j] + "' width='75%'/><p><i>" + datajudul[j] + "</i>  Movies, tell story about " + datades[j] + "</p><p>Watch <strong>" + datajudul[j] + "</strong> Full Movie For Free, Please Click button bellow!</p><div id='playnow'><a href='https://top-movies.de2wa.com/play.php?movie=" + idmovie + "&lang=en'> <img  width='250px' src='https://cdnx.de2wa.com/asset/watch.jpg'></a></div><!--more-->"] ;
