...
rm *.ts
rm *.mp4
yt-dlp -f 22 https://www.youtube.com/watch?v=MkX43WNgfes -o input1.mp4
...
for (( i=1 ; i<=10; i++ ));  do 
ffmpeg -i "input1.mp4" -ss 00:0$(shuf -i 1-9 -n 1):00 -t 00:0$(shuf -i 5-9 -n 1):00 -acodec copy  -vcodec copy -vbsf h264_mp4toannexb -f mpegts "intro$i.ts"
done
